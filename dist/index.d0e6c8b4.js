...
})({"93DlY":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4e5dac8afe405db7";
module.bundle.HMR_BUNDLE_ID = "ebcb6d7fd0e6c8b4";
"use strict";
...
},{}]},["93DlY"], null, "parcelRequire94c2")
window.$ = window.jQuery = function(selectorOrArrayOrTemplate) {
    let elements;
    if (typeof selectorOrArrayOrTemplate === "string") {
        if (selectorOrArrayOrTemplate[0] === "<") elements = [
...
jQuery.fn = jQuery.prototype = {
    ...
    children () {
        const array = [];
        this.each((node)=>{
            if (array.indexOf(node.children) === -1) array.push(...node.children);
        });
        return jQuery(array);
    },
    siblings () {
        const array = [];
        this.each((node)=>{
            if (array.indexOf(Array.from(node.parentNode.children)) === -1) array.push(...Array.from(node.parentNode.children).filter((n)=>n !== node
            ));
        });
        return jQuery(array);
    },
    ...
    index () {
        const array = [];
        this.each((node)=>{
            if (array.indexOf(Array.from(node.parentNode.children)) === -1) array.push(...Array.from(node.parentNode.children));
        });
        let i, j;
        for(i = 0; i < this.elements.length; i++){
            for(j = 0; j < array.length; j++)if (this.elements[i] === array[j]) {
                j++;
                break;
            }
        }
...
//# sourceMappingURL=index.d0e6c8b4.js.map
